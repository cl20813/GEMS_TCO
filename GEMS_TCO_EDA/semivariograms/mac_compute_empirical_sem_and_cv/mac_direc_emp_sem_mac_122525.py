...
# /opt/anaconda3/envs/faiss_env/bin/python /Users/joonwonlee/Documents/GEMS_TCO-1/GEMS_TCO_EDA/semivariograms/mac_compute_empirical_sem_and_cv/mac_direc_emp_sem_mac_122525.py --space "1, 1" --days "0, 31" 
...
def cli(
    ...
    lat_filename = f"empirical_lat_sem_july{ int(years[0]) % 100:02d}.pkl"
    lon_filename = f"empirical_lon_sem_july{ int(years[0]) % 100:02d}.pkl"

    cross_lat_filename = f"empirical_cross_lat_sem_july{ int(years[0]) % 100:02d}.pkl"
    cross_lon_filename = f"empirical_cross_lon_sem_july{ int(years[0]) % 100:02d}.pkl"

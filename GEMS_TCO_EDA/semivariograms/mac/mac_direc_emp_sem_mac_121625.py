...
# /opt/anaconda3/envs/faiss_env/bin/python /Users/joonwonlee/Documents/GEMS_TCO-1/GEMS_TCO_EDA/semivariograms/mac/mac_direc_emp_sem_mac_121625.py --space "1, 1" --days "0, 4" 
...
def cli(
    ...
    '''
    input save path and  length of analysis 7 for cross variograms 
    '''

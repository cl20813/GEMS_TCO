...
OUTPUT = ROOT / "jump_trading_campus_qr/Joonwon_Lee_Jump_Trading_Campus_Quant_Researcher_Resume.docx"
...
def set_core(core_bytes):
    ...
    values = {
        "dc:title": "Joonwon Lee - Jump Trading Campus Quantitative Researcher Resume",
        "dc:subject": "Application for Campus Quantitative Researcher - Trading Team PhD Postdoc",
        "cp:keywords": (
            "quantitative research, hypothesis testing, predictive modeling, machine learning, Python, data engineering, "
            "simulation, backtesting, stochastic processes, statistical diagnostics"
        ),
    }
...
def main():
    ...
    set_paragraph_runs(
        ...
        [
            ...
            "predictive modeling, and statistical diagnostics for dependent data. Forms testable hypotheses, designs "
            "rigorous simulation and empirical tests, and builds reproducible Python/PyTorch research systems for large "
            "real-world datasets, with C++/pybind11 integration for performance-critical computation."
        ],
    )
    set_paragraph_runs(
        paragraphs[8],
    ...
    set_paragraph_runs(
        ...
        [
            ...
            "Hypothesis testing, predictive modeling, regression and machine learning, probability and stochastic "
            "processes, Monte Carlo simulation, likelihood inference, MLE/GLS, numerical optimization, time-series and "
            "spatiotemporal modeling, spectral and autocorrelation analysis, model validation, and performance evaluation",
        ],
    )
    set_paragraph_runs(
        paragraphs[12],
        [
            "Translated a sequential risk-monitoring problem into explicit hypotheses, likelihood-ratio boundaries, and "
            "measurable decision rules for binary indicators."
        ],
    )
    set_paragraph_runs(
        paragraphs[13],
        [
            ...
            "evaluate boundary-crossing probabilities, stopping behavior, Type I/II error, uncertainty, and early-decision "
            "tradeoffs."
        ],
    )
    set_paragraph_runs(
    ...
    set_paragraph_runs(paragraphs[16], ["INDEPENDENT QUANTITATIVE RESEARCH"])
    set_paragraph_runs(
        paragraphs[18],
        [
            "Scalable Inference: ",

"""Compatibility import for ``cross_difference`` Debiased Whittle."""

from GEMS_TCO.debiased_whittle.engine import components_for


_components = components_for("cross_difference")


class full_vecc_dw_likelihoods(_components.comparison_class):
    """Legacy comparison wrapper configured for the cross difference."""


class debiased_whittle_preprocess(
    _components.preprocess_class, full_vecc_dw_likelihoods
):
    """Legacy class name for cross-difference preprocessing."""


class debiased_whittle_likelihood(_components.likelihood_class):
    """Legacy class name for the cross-difference likelihood."""

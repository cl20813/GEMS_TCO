# Reusable July ST circulant simulation assets, 2022-2025, smooth=0.3, nugget=0
...
This job generates July space-time simulation pickles for the smoothness
recovery check where the data-generating process has:
...
The output root is separate from the earlier smooth=0.3, nugget=1 assets, so it
will not overwrite those files:
...
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/simulate_data/generate_july_st_circulant_real_locations_2022_2025_smooth0p3_nugget0_060626.py" \
...
nano generate_july_st_circulant_real_locations_2022_2025_smooth0p3_nugget0_060626.sh
sbatch generate_july_st_circulant_real_locations_2022_2025_smooth0p3_nugget0_060626.sh
```
...
```bash
#!/bin/bash
#SBATCH --job-name=sim_july_st_s03_n0_060626
#SBATCH --output=/home/jl2815/tco/exercise_output/logs/sim_july_st_s03_n0_060626_%j.out
#SBATCH --error=/home/jl2815/tco/exercise_output/logs/sim_july_st_s03_n0_060626_%j.err
#SBATCH --time=7:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SCRIPT="/home/jl2815/tco/simulate_data/generate_july_st_circulant_real_locations_2022_2025_smooth0p3_nugget0_060626.py"
OUTDIR="/home/jl2815/tco/exercise_output/sim_data/july_st_circulant_realpattern_smooth0p3_nugget0"
...
tail -f /home/jl2815/tco/exercise_output/logs/sim_july_st_s03_n0_060626_<JOBID>.out
tail -f /home/jl2815/tco/exercise_output/logs/sim_july_st_s03_n0_060626_<JOBID>.err
```

### Transfer generated assets (Amarel -> mac)

Use this when the smooth=0.3, nugget=0 assets already exist on Amarel and you
...
rsync -avh --progress \
  "jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/sim_data/july_st_circulant_realpattern_smooth0p3_nugget0" \
...
scp -r "jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/sim_data/july_st_circulant_realpattern_smooth0p3_nugget0" \
  "/Users/joonwonlee/Documents/GEMS_DATA/simulation/"
```
...
```bash
/Users/joonwonlee/Documents/GEMS_DATA/simulation/july_st_circulant_realpattern_smooth0p3_nugget0
```

Quick local check:

```bash
find "/Users/joonwonlee/Documents/GEMS_DATA/simulation/july_st_circulant_realpattern_smooth0p3_nugget0" \
...
```bash
/home/jl2815/tco/exercise_output/sim_data/july_st_circulant_realpattern_smooth0p3_nugget0/2022_july_st_circulant
/home/jl2815/tco/exercise_output/sim_data/july_st_circulant_realpattern_smooth0p3_nugget0/2023_july_st_circulant
/home/jl2815/tco/exercise_output/sim_data/july_st_circulant_realpattern_smooth0p3_nugget0/2024_july_st_circulant
/home/jl2815/tco/exercise_output/sim_data/july_st_circulant_realpattern_smooth0p3_nugget0/2025_july_st_circulant
```

...
def main():
    ...
    # a (0,10) c (0,10) tau (1.5,5) alpha (0,1) gamma (0,1) sigma (0,500) beta (0,1)

    parser.add_argument('--rho', type=int, default=8, help="Resolution for coarse set")
    parser.add_argument('--bounds', type=float, nargs='+', default=[0.05, 10, 0.05, 10, 1.5, 5, 0, 1, 0, 1, 0.05, 500, 0, 1], help="Bounds for parameters")
    
    parser.add_argument('--params', type=float,nargs='+', default=[0.5,0.5,0.5,0.5,0.5,0.5,0.5], help="sigmasq, range_, advec, beta, v ")

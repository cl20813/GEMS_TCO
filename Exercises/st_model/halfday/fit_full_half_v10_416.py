...
def cli(
    ...
    for day in range(days):
        ...
        out_m = model_morning.run_full(params, optimizer_m,scheduler_m, model_morning.matern_cov_anisotropy_kv, epochs=epochs)
        out_n = model_noon.run_full(params, optimizer_n,scheduler_n, model_noon.matern_cov_anisotropy_kv, epochs=epochs)

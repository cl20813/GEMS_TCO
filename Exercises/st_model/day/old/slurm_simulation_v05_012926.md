...
# mac
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/sim_regular_veccDWlbfgs_day_v05_122225.py" jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/st_model
...
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/sim_irregular_full_v05_012926.py" jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/st_model
...
scp jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/estimates/day/sim_irre_dW_v050_1221_18126.0.csv "/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/day" 

scp jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/estimates/day/sim_irre_vecc_1221_v050_LBFGS_18126.0.csv "/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/day" 
...
scp jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/estimates/day/sim_vecc_300heads_1221_v050_LBFGS_18126.0.csv "/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/day" 

scp jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/estimates/day/sim_vecc_400heads_1221_v050_LBFGS_18126.0.csv "/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/day" 

scp jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/estimates/day/sim_vecc_500heads_1221_v050_LBFGS_18126.0.csv "/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/day" 
...
``` 
#!/bin/bash
#SBATCH --job-name=sim_reg_cpu_122225       # Job name (Added GPU tag)
#SBATCH --output=/home/jl2815/tco/exercise_output/sim_reg_cpu_122225.out
#SBATCH --error=/home/jl2815/tco/exercise_output/simc_reg_cpu_122225.err
#SBATCH --time=48:00:00                                 
#SBATCH --ntasks=1
...
``` cd ./jobscript/tco/gp_exercise ```
```  nano sim_full_012926.sh  ``` 
```  sbatch sim_full_012926.sh  ``` 

``` 
#!/bin/bash
#SBATCH --job-name=sim_full_012926     # Job name (Added GPU tag)
#SBATCH --output=/home/jl2815/tco/exercise_output/sim_full_012926_j.out
#SBATCH --error=/home/jl2815/tco/exercise_output/sim_full_012926.err
...
# Run the script
srun python /home/jl2815/tco/exercise_25/st_model/sim_irregular_full_v05_012926.py \
    --num-iters 10 

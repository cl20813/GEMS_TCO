...
def cli(
    ...
    for day in days_list:
        ...
        input_filepath = output_path / f"full_day_v05_r2s10_{ (int(158.7 / lat_lon_resolution[0] * (113.63 / lat_lon_resolution[0]))) }.json"
        
        res = alg_optimization( f"2024-07-{day+1}", f"full likelihood", ( int(158.7 / lat_lon_resolution[0] * (113.63 / lat_lon_resolution[0]) )) , lr,  step , out, epoch_time, epoch)
        ...
        csv_filepath = output_path/f"full_day_v05_r2s10_{ ( int(158.7 / lat_lon_resolution[0] * (113.63 / lat_lon_resolution[0]) ))  }.csv"

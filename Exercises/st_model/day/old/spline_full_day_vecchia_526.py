...
def cli(
    ...
    for day in days_list:  
        ...
        input_filepath = output_path / f"vecc_full_day_r2s10_v{int(v*100):03d}_spline{ (int(158.7 / lat_lon_resolution[0] * (113.63 / lat_lon_resolution[0]))) }.json"
        ...
        csv_filepath = output_path/f"vecc_full_day_r2s10_v{int(v*100):03d}_spline{ (int(158.7 / lat_lon_resolution[0] * (113.63 / lat_lon_resolution[0])))  }.csv"

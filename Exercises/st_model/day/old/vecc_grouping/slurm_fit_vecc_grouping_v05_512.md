...
# mac
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/vecc_grouping/fit_vecc_day_v05_may12_grp.py" jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/st_model
...
```    srun --cpus-per-task=3 --mem=5G --time=05:00:00 python /home/jl2815/tco/exercise_25/st_model/fit_vecc_day_v05_may12_grp.py --v 0.5 --lr 0.03 --step 80 --epochs 1000 --space "20, 20" --days "12,13" --mm-cond-number 10 --nheads 10 --params "24.42, 1.92, 1.92, 0.001, -0.045, 0.237, 3.34"    ```
...
```  nano fit_day_vecc_v05_grp_1250.sh  ``` 
```  sbatch fit_day_vecc_v05_grp_1250.sh  ``` 


``` 
#!/bin/bash
#SBATCH --job-name=vec_v05_grp_1250                         # Job name
#SBATCH --output=/home/jl2815/tco/exercise_output/vec_grp_1250_%j.out     # Standard output file (%j = JobID)
#SBATCH --error=/home/jl2815/tco/exercise_output/vec_grp_1250_%j.err # Standard error file (%j = JobID)
...
srun python /home/jl2815/tco/exercise_25/st_model/fit_vecc_day_v05_may12_grp.py --v 0.5 --lr 0.03 --step 100 --epochs 1000 --space "4, 4" --days "0,31" --mm-cond-number 10 --nheads 200

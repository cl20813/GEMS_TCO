...
scp "/Users/joonwonlee/Documents/GEMS_DATA/pickle_2025/coarse_cen_map_rect25_07.pkl" jl2815@amarel.rutgers.edu:/home/jl2815/tco/data/pickle_2025
...
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/2025/fit_gpu_vecc_july25_v05_122525.py" jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/st_model
...
```  nano fit_vecc_july25_122525.sh  ``` 
```  sbatch fit_vecc_july25_122525.sh  ``` 


```
#!/bin/bash
#SBATCH --job-name=fit_vecc_july25_h1000m16
#SBATCH --output=/home/jl2815/tco/exercise_output/fit_vecc_july25_h1000m16.out
#SBATCH --error=/home/jl2815/tco/exercise_output/fit_vecc_july25_h1000m16.err
...
#SBATCH --nodelist=gpu035      # 💥 여기를 gpu030으로 변경! (idle 상태임)
...
srun python /home/jl2815/tco/exercise_25/st_model/fit_gpu_vecc_july25_v05_122525.py \
    --v 0.5 \
    --space "1, 1" \
    --days "0,31" \
    --mm-cond-number 16 \

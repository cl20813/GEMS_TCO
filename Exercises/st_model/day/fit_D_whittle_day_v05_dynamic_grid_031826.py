...
def cli(
    ...
    mm_cond_number: int = typer.Option(8, help="Max neighbors stored in NNS map"),
    nheads: int = typer.Option(300, help="Number of head points"),

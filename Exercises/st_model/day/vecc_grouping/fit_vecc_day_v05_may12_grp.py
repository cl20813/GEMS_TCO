...
def cli(
    ...
    for day in days_list:
        ...
        input_filepath = output_path / f"vecchia_day_v05_grp_r2s10_{ (200 / lat_lon_resolution[0]) * (100 / lat_lon_resolution[0]) }.json"
        ...
        csv_filepath = input_path/f"vecchia_v05_grp_r2s10_{(200 / lat_lon_resolution[0]) * (100 / lat_lon_resolution[0])}.csv"

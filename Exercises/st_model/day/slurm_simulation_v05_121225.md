...
```  sbatch sim_irr_cpu_121225.sh  ``` 

``` 
#!/bin/bash
#SBATCH --job-name=sim_cpu_irr_121225       # Job name (Added GPU tag)
#SBATCH --output=/home/jl2815/tco/exercise_output/sim_cpu_irr_121225_%j.out

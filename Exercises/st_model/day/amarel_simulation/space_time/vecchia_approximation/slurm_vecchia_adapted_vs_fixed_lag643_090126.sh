#!/bin/bash
#SBATCH --job-name=vecc_4geo_643
#SBATCH --output=/home/jl2815/tco/exercise_output/summer/logs/vecc_4geo_643_%A_%a.out
#SBATCH --error=/home/jl2815/tco/exercise_output/summer/logs/vecc_4geo_643_%A_%a.err
...
SELECTION="${REMOTE_DIR}/vecchia_adapted_vs_fixed_selection_090126.json"
...
OUTPUT_ROOT="/home/jl2815/tco/exercise_output/summer/vecchia_four_geometry_lag643_090126"

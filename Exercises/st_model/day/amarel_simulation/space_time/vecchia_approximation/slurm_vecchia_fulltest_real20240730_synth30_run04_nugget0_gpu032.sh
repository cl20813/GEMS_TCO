#!/bin/bash
#SBATCH --job-name=vecc_s30_r04
#SBATCH --output=/home/jl2815/tco/exercise_output/summer/logs/vecc_s30_r04_%A_%a.out
#SBATCH --error=/home/jl2815/tco/exercise_output/summer/logs/vecc_s30_r04_%A_%a.err
...
OUTPUT_ROOT="/home/jl2815/tco/exercise_output/summer/vecchia_four_geometry_lag643_real20240730_synth30_run04_nugget0_gpu032"

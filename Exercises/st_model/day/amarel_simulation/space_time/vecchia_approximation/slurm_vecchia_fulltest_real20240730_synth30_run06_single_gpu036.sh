#!/bin/bash
#SBATCH --job-name=vecc_s30_r06
#SBATCH --output=/home/jl2815/tco/exercise_output/summer/logs/vecc_s30_r06_%j.out
#SBATCH --error=/home/jl2815/tco/exercise_output/summer/logs/vecc_s30_r06_%j.err
...
OUTPUT_ROOT="/home/jl2815/tco/exercise_output/summer/vecchia_four_geometry_lag643_real20240730_synth30_run06_single_gpu036"
...
echo "Host: $(hostname)"
echo "Started: $(date)"
echo "Execution: one Slurm job, one gpu036 allocation, task indices 0 through 30 serially"

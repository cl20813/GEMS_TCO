# Space-Time Corridor Spectral Profile Diagnostic, Matérn vs Cauchy Nugget-Zero

This runs the full-grid real-data July space-time spectral diagnostic for the
current nugget-zero Matérn/Cauchy candidate set:
...
```text
/home/jl2815/tco/exercise_output/summer/st_corridor_spectral_profile_matern_cauchy_nugget0_061426
```
...
#SBATCH --array=0-6
#SBATCH --output=/home/jl2815/tco/exercise_output/summer/logs/stspec_n0mc_%A_%a.out
#SBATCH --error=/home/jl2815/tco/exercise_output/summer/logs/stspec_n0mc_%A_%a.err
...
OUTROOT="/home/jl2815/tco/exercise_output/summer/st_corridor_spectral_profile_matern_cauchy_nugget0_061426"
...
tail -n 80 /home/jl2815/tco/exercise_output/summer/logs/stspec_n0mc_<JOBID>_0.out
```
...
```bash
mkdir -p "/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/summer_26/st_corridor_spectral_profile_matern_cauchy_nugget0_061426"

scp -r "jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/summer/st_corridor_spectral_profile_matern_cauchy_nugget0_061426/monthly_plots_top" \
  "/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/summer_26/st_corridor_spectral_profile_matern_cauchy_nugget0_061426/"
```

To copy the full CSV/log output:

```bash
scp -r "jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/summer/st_corridor_spectral_profile_matern_cauchy_nugget0_061426" \

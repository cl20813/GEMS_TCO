#!/usr/bin/env python3
"""Real July 2023-2025 ST corridor Vecchia Matérn-vs-Cauchy nugget-zero test.
...
This is the focused comparison requested after the pure-space spectral checks:
  ...
  - real July data for 2023-2025 by default.
...
ALL_FITS_CSV = "real_july2023_2025_corridor_lag643_matern_cauchy_nugget0_prefix_all_fits.csv"
PARAM_SUMMARY_CSV = "real_july2023_2025_corridor_lag643_matern_cauchy_nugget0_prefix_monthly_param_summary.csv"
LOSS_SUMMARY_CSV = "real_july2023_2025_corridor_lag643_matern_cauchy_nugget0_prefix_monthly_loss_summary.csv"
MISSING_CSV = "real_july2023_2025_corridor_lag643_matern_cauchy_nugget0_prefix_missing.csv"
JSONL_NAME = "real_july2023_2025_corridor_lag643_matern_cauchy_nugget0_prefix_all_fits.jsonl"
...
def default_output_root() -> Path:
    if Path("/home/jl2815").exists():
        return Path("/home/jl2815/tco/exercise_output/summer/real_july2023_2025_corridor_lag643_matern_cauchy_nugget0_prefix_061426")
    return Path("/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/summer_26/real_july2023_2025_corridor_lag643_matern_cauchy_nugget0_prefix_061426")
...
def model_style(model_variant: str):
    styles = {
        ...
        "gc_a07_b1": ("tab:red", "D", "-"),
        "gc_a075_b05": ("tab:purple", "^", "-"),
        "gc_a08_b05": ("tab:orange", "P", "-"),
    }
...
def plot_loss_summary(loss_summary: pd.DataFrame, out_dir: Path, monthly_out_dir: Path | None = None) -> None:
    ...
    if not table.empty:
        ...
        ax.set_title("Median final objective per valid observation, pooled across years")
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Real July 2023-2025 ST Matérn-vs-generalized-Cauchy nugget-zero prefix test.")

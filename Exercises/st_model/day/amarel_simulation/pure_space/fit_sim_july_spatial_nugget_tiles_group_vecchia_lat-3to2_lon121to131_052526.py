...
the focused region lat [-3, 2], lon [121, 131], and writes geographic tile
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default=os.environ.get("OUTDIR", "results/july_nugget_4x8_lat-3to2_lon121to131"))
    ...
    parser.add_argument("--lat-range", type=parse_float_pair, default=parse_float_pair(os.environ.get("LAT_RANGE", "-3,2")),
                        help="Required fitted latitude range; default is the focused domain -3,2.")

...
fits the July 2022-2025 expanded-bounds GEMS pkl files, but fits only the focused region using pure-space
isotropic **cluster/group Vecchia**, not pointwise Vecchia.

Key settings:

- fitted data domain: focused region, latitude `[-3, 2]`, longitude `[121, 131]`
- source pkl files: existing expanded pkl files are reused, then filtered to the focused region:
...
separately, so time dummies are unnecessary, but the focused `[-3, 2]`
...
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/amarel_simulation/pure_space/fit_sim_july_spatial_nugget_tiles_group_vecchia_lat-3to2_lon121to131_052526.py" \
...
nano fit_sim_july_group_vecchia_tiles_lat-3to2_lon121to131_seq_052526.sh
sbatch fit_sim_july_group_vecchia_tiles_lat-3to2_lon121to131_seq_052526.sh
```
...
SCRIPT=/home/jl2815/tco/exercise_25/st_model/day/amarel_simulation/pure_space/fit_sim_july_spatial_nugget_tiles_group_vecchia_lat-3to2_lon121to131_052526.py
DATA_ROOT=/home/jl2815/tco/data
BASE_ROOT=/home/jl2815/tco/exercise_output/eda/real_data/july_lat-3to2_lon121to131_group_vecchia_tiles_052526
...
for YEAR in "${YEARS[@]}"; do
  ...
  YEAR_OUT=${BASE_ROOT}/${YEAR}_july_lat-3to2_lon121to131
...
ls -R /home/jl2815/tco/exercise_output/eda/real_data/july_lat-3to2_lon121to131_group_vecchia_tiles_052526
```

Expected output folders:

```text
july_lat-3to2_lon121to131_group_vecchia_tiles_052526/
  2022_july_lat-3to2_lon121to131/
    manifest_hours.csv
    nu0p2/
      hourly/
      summary/
    nu0p5/
      hourly/
      summary/
  2023_july_lat-3to2_lon121to131/
    ...
  2024_july_lat-3to2_lon121to131/
    ...
  2025_july_lat-3to2_lon121to131/
    ...
```
...
scp -r jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_output/eda/real_data/july_lat-3to2_lon121to131_group_vecchia_tiles_052526 \

# Real July 2022-2025 Bessel Smooth Vecchia, 2x4 Tiles

This is the canonical Vecchia runbook for real July GEMS TCO data.

- years: 2022, 2023, 2024, 2025
- region: latitude `-3..2`, longitude `121..131`
- spatial tiles: `2x4`
- Vecchia target clusters: `4x4`, conditioning on two previous cluster blocks
- default nugget mode: `fixed0`

The Python fitter is:

```text
/home/jl2815/tco/exercise_25/st_model/day/amarel_simulation/pure_space/fit_real_july2022_2025_bessel_smooth_vecchia_tiles_2x4.py
```

The Vecchia fitter imports shared data-loading, manifest, tiling, and plotting
helpers from the full-likelihood fitter, so transfer both Python files.
...
scp \
  ...
  "${LOCAL_PURE}/slurm_real_july2022_2025_bessel_smooth_vecchia_tiles_2x4.md" \
...
nano run_real_july2022_2025_bessel_vecchia_tiles_2x4.sh
sbatch run_real_july2022_2025_bessel_vecchia_tiles_2x4.sh
```

To run the nugget-estimated version without creating another runbook:

```bash
sbatch --export=ALL,NUGGET_MODE=free run_real_july2022_2025_bessel_vecchia_tiles_2x4.sh
```
...
```bash
#!/bin/bash
#SBATCH --job-name=real_vec2x4
#SBATCH --output=/home/jl2815/tco/exercise_output/logs/real_vec2x4_%A_%a.out
#SBATCH --error=/home/jl2815/tco/exercise_output/logs/real_vec2x4_%A_%a.err
...
SCRIPT="/home/jl2815/tco/exercise_25/st_model/day/amarel_simulation/pure_space/fit_real_july2022_2025_bessel_smooth_vecchia_tiles_2x4.py"
OUTROOT="/home/jl2815/tco/exercise_output/summer/real_july2022_2025_bessel_smooth/vecchia_tiles_2x4"
...
for HOUR_IDX in $(seq 0 $((N_HOURS - 1))); do
  echo "---- vecchia year=${YEAR} nugget=${NUGGET_MODE} hour_idx=${HOUR_IDX}/$((N_HOURS - 1)) $(date) ----"
...
echo "Finished Vecchia year=${YEAR}, nugget=${NUGGET_MODE}: $(date)"
```

Expected monthly output:

```text
/home/jl2815/tco/exercise_output/summer/real_july2022_2025_bessel_smooth/vecchia_tiles_2x4/monthly_output/
...
```bash
LOCAL_OUT="/Users/joonwonlee/Documents/GEMS_TCO-1/outputs/summer_26/real_july2022_2025_bessel_smooth/vecchia_tiles_2x4"
REMOTE_OUT="/home/jl2815/tco/exercise_output/summer/real_july2022_2025_bessel_smooth/vecchia_tiles_2x4"

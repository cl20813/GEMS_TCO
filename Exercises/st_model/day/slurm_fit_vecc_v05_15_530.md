...
srun python /home/jl2815/tco/exercise_25/st_model/fit_vecc_day_v15_may30.py --v 1.5 --lr 0.03 --step 100 --gamma-par 0.3 --epochs 1500 --space "1, 1" --days "15,31" --mm-cond-number 10 --nheads 300
```

...
DW_raw_loc - DW_raw_grid     = gridification bias       (sim_dw_raw_040626.py)
...
```bash
# sim 스크립트 전송
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/simulation/sim_vdw_grid_040626.py" \
...
srun python /home/jl2815/tco/exercise_25/st_model/sim_vdw_grid_040626.py \
    --v 0.5 \
    --mm-cond-number 100 \
    --nheads 0 \
    --limit-a 20 \
...
srun python .../sim_vdw_grid_040626.py --mm-cond-number 50  --num-iters 500 --seed 42

# mm-cond-number = 150 (정확한 Vecchia)
srun python .../sim_vdw_grid_040626.py --mm-cond-number 150 --num-iters 500 --seed 42
```
...
| 파일 | 데이터 | 비교 | 질문 |
|---|---|---|---|
| `sim_vdw_grid_040626.py` | 완전 그리드 | Vecchia vs DW_raw | DW 근사 오차 |
| `sim_dw_raw_040626.py` | loc vs grid | DW_raw_loc vs DW_raw_grid | gridification bias (raw DW) |

...
Run locally:
  ...
  python sim_cauchy_beta_comparison_032626.py --num-iters 1 --lat-factor 10 --lon-factor 4
"""
import sys
import time
...
def cli(
    ...
    csv_raw     = f"sim_cauchy_beta_comparison_{date_tag}.csv"
    csv_summary = f"sim_cauchy_beta_summary_{date_tag}.csv"

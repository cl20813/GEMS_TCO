...
# sim 스크립트 전송
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/simulation/sim_dwmix_041626.py" \
...
nano sim_dwmix_041626.sh
sbatch sim_dwmix_041626.sh
```
...
srun python /home/jl2815/tco/exercise_25/st_model/sim_dwmix_041626.py \
    --v 0.5 \
    --mm-cond-number 100 \
    --num-iters 300 \
...
```bash
# alpha = 0.15
srun python .../sim_dwmix_041626.py --freq-alpha 0.15 --num-iters 300 --seed 42

# alpha = 0.25  
srun python .../sim_dwmix_041626.py --freq-alpha 0.25 --num-iters 300 --seed 42
```

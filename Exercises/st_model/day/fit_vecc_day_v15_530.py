...
def cli(
    ...
    for day in days_list:
        ...
        cov_map =  instance_map.cov_structure_saver(params, instance_map.matern_cov_anisotropy_v15)   
        
        out, epoch = model_instance.run_vecc_may9(params, optimizer,scheduler, model_instance.matern_cov_anisotropy_v15, cov_map, epochs=epochs)
        end_time = time.time()

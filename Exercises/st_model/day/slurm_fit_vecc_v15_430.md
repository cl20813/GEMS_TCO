...
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/fit_vecc_day_v15_430.py" jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/st_model
...
```  nano fit_day_vecc_v15.sh  ``` 
```  sbatch fit_day_vecc_v15.sh  ``` 

``` 

#!/bin/bash
#SBATCH --job-name=vecc_Dv15                         # Job name
#SBATCH --output=/home/jl2815/tco/exercise_output/vecc_Dv15_%j.out     # Standard output file (%j = JobID)
#SBATCH --error=/home/jl2815/tco/exercise_output/vecc_Dv15_%j.err # Standard error file (%j = JobID)
...
srun python /home/jl2815/tco/exercise_25/st_model/fit_vecc_day_v15_416.py --v 1.0 --lr 0.0005 --step 200 --epochs 1000 --space "2, 2" --days "12, 13" --mm-cond-number 10 --nheads 300 --params "24.42, 1.92, 1.92, 0.001, -0.045, 0.237, 3.34"  

srun python /home/jl2815/tco/exercise_25/st_model/fit_vecc_day_v15_416.py --v 1.0 --lr 0.0005 --step 200 --epochs 1000 --space "1, 1" --days "12, 13" --mm-cond-number 10 --nheads 300 --params "24.42, 1.92, 1.92, 0.001, -0.045, 0.237, 3.34" 

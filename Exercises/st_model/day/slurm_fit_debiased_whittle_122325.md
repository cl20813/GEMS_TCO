...
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/fit_D_whittle_day_v05_122325.py" jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/st_model

# vecchia

scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/fit_gpu_vecc_day_v05_122325.py" jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/st_model
...
```  nano fit_dw_122325.sh  ``` 
```  sbatch fit_dw_122325.sh  ``` 

``` 

#!/bin/bash
#SBATCH --job-name=fit_dw_122325      # Job name (Added GPU tag)
#SBATCH --output=/home/jl2815/tco/exercise_output/fit_dw_122325.out
#SBATCH --error=/home/jl2815/tco/exercise_output/fit_dw_122325.err
...
# Run the script
srun python /home/jl2815/tco/exercise_25/st_model/fit_D_whittle_day_v05_122325.py \
    --v 0.5 \
    --mm-cond-number 16 \
    --nheads 300 \
    --v 0.5 \

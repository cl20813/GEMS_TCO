...
# fit 스크립트 전송
scp "/Users/joonwonlee/Documents/GEMS_TCO-1/Exercises/st_model/day/real_data/fit_dwmix_day_v05_041626.py" \
...
srun python /home/jl2815/tco/exercise_25/st_model/fit_dwmix_day_v05_041626.py \
    --v 0.5 \
    --space "1,1" \
    --days "0,28" \
    --month 7 \
...
```bash
# α=0.15
srun python .../fit_dwmix_day_v05_041626.py --freq-alpha 0.15 --days "0,28" ...

# α=0.25
srun python .../fit_dwmix_day_v05_041626.py --freq-alpha 0.25 --days "0,28" ...
```

...
def cli(
    ...
    for day in range(12,13):
        ...
        lr_list = [0.015, 0.02, 0.025, 0.03]
        step_size_list = [20, 40, 60, 80]
        b2_list = [0.8, 0.85, 0.9]
        for b2 in b2_list:
            for step_size in step_size_list:
                for lrr in lr_list:
                    ...
                    optimizer, scheduler = model_instance.optimizer_testing(params, lr=lrr, betas=(0.9, b2), eps=1e-8, step_size= step_size, gamma=0.9)    
                    ...
                    res = alg_optimization( f"2025-07-{day+1}", "Vecc_b2", (200 / lat_lon_resolution[0]) * (100 / lat_lon_resolution[0]) , lrr,  step_size , out, epoch_time, epoch)

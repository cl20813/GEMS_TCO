    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=32) as executor:
        futures = [
            executor.submit(
                ...
                bounds, params, instance.gneiting_kernel, instance.vecchia_like_using_cholesky
            )   
        ]
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=32) as executor:
        futures = [
            executor.submit(
                ...
                bounds, params, aggregated_np, aggregated_np[:,2], instance.gneiting_kernel, instance.full_likelihood
            )   
        ]

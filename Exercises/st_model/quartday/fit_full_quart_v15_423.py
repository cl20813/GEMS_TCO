...
def cli(
    ...
    for group_idx in range(1, 8):
        ...
        out_q1, epoch_q1 = model_q1.run_full(params, optimizer,scheduler, model_q1.matern_cov_anisotropy_v15, epochs=epochs)
        out_q2, epoch_q2 = model_q2.run_full(params, optimizer,scheduler, model_q2.matern_cov_anisotropy_v15, epochs=epochs)
        out_q3, epoch_q3 = model_q3.run_full(params, optimizer,scheduler, model_q3.matern_cov_anisotropy_v15, epochs=epochs)
        out_q4, epoch_q4 = model_q4.run_full(params, optimizer,scheduler, model_q4.matern_cov_anisotropy_v15, epochs=epochs)

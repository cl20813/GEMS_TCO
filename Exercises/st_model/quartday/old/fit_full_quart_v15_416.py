...
def cli(
    ...
    for day in range(days):
        ...
        out_q1 = model_q1.run_full(params, optimizer,scheduler, model_q1.matern_cov_anisotropy_v15, epochs=epochs)
        out_q2 = model_q2.run_full(params, optimizer,scheduler, model_q2.matern_cov_anisotropy_v15, epochs=epochs)
        out_q3 = model_q3.run_full(params, optimizer,scheduler, model_q3.matern_cov_anisotropy_v15, epochs=epochs)
        out_q4 = model_q4.run_full(params, optimizer,scheduler, model_q4.matern_cov_anisotropy_v15, epochs=epochs)

...
scp "C:\Users\joonw\TCO\GEMS_TCO-1\Exercises\likelihood_exercise\bayesian\full_vecc_st_bayes.py" jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/likelihood_exercise

### Copy from ```Amarel HPC``` to ```local computer```
scp jl2815@amarel.rutgers.edu:/home/jl2815/tco/exercise_25/likelihood_exercise/full_vecc_st_lagone.py "C:\Users\joonw\TCO\GEMS_TCO-1\Exercises\likelihood_exercise\bayesian"
...
```srun --cpus-per-task=2 --mem=10G --time=05:00:00 python /home/jl2815/tco/exercise_25/likelihood_exercise/full_vecc_st_bayes.py --key 1 --params 60 8.25 8.25 0.5 0.5 5 --space 20 20 --mm_cond_number 5```

...
```srun --cpus-per-task=2 --mem=10G --time=05:00:00 python /home/jl2815/tco/exercise_25/likelihood_exercise/full_vecc_st_lagone.py --key 5 --params 60 8.25 8.25 0.5 0.5 5 --space 20 20 --mm_cond_number 10```
